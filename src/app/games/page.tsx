        ...
        <MarketingLayout>
            <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center overflow-hidden relative">
                ...
                <div className="container mx-auto px-4 text-center relative z-10">
                    ...
                    >
                        <div className="w-24 h-24 mx-auto bg-gradient-to-br from-green-500 to-emerald-500 rounded-3xl flex items-center justify-center shadow-2xl shadow-green-500/20">
                    ...
                    >
                        الألعاب <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-400">التعليمية</span>
                    </motion.h1>
                    ...
                    >
                        نحن نعمل على تطوير مجموعة من الألعاب الفيزيائية الممتعة. استعد للتحدي قريباً!
                    </motion.p>
