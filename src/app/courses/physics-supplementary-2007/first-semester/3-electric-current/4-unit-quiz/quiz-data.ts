...
export const unit3QuizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      { text: '', image: 'https://i.ibb.co/HpCpdN0P/13.png', imageHint: 'conductor length L area A' },
      { text: '', image: 'https://i.ibb.co/wZ0cs3DT/13.png', imageHint: 'conductor length 2L area A' },
      { text: '', image: 'https://i.ibb.co/XfLBW3V9/13.png', imageHint: 'conductor length L area 2A' },
      { text: '', image: 'https://i.ibb.co/395PYFtR/13.png', imageHint: 'conductor length 2L area 2A' },
    ],
    correctAnswerIndex: 2,
