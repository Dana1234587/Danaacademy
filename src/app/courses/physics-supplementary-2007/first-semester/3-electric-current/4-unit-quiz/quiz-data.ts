...
export const unit3QuizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    correctAnswerIndex: 3,
    explanation: 'عندما يكون المفتاح مفتوحًا، لا يمر تيار في الدائرة، وبالتالي فإن قراءة الفولتميتر تساوي القوة الدافعة الكهربائية للبطارية. إذن، $\\varepsilon = 9 V$. عندما يتم إغلاق المفتاح، يمر تيار في الدائرة وقراءة الفولتميتر تمثل الجهد الطرفي للبطارية، $V = 8 V$. التيار المار في الدائرة هو $I = V/R = 8/8 = 1 A$. يمكننا الآن حساب المقاومة الداخلية باستخدام العلاقة $\\varepsilon = V + Ir$. بالتعويض، $9 = 8 + 1 \\cdot r$, مما يعطي $r=1\\Omega$.',
  }
];
