...
export const unit3QuizQuestions: QuizQuestion[] = [
  ...
  {
    id: 2,
    questionText: 'موصلان نحاسيان يختلفان عن بعضهما في الطول ومساحة المقطع طول الموصل الأول $l$ ونصف قطره $r$ , اما الموصل الثاني طوله $3l$ ونصف قطره $2r$ إذا وصل طرفي كل منهما بمصدر فرق جهد $V$ فإن نسبة $\\frac{I_2}{I_1}$ ونسبة $\\frac{\\rho_2}{\\rho_1}$ على الترتيب هما:',
    options: [
...
4. **نفرض أن الخيار (أ) هو الصحيح للتحقق:** $R=2.5\\Omega$ و $V_{dc}=15V$.
5. **إذا كان $V_{dc} = 15V$** (أي أن جهد $d$ أعلى من $c$)،  يمكننا حساب $V_{ad}$ عبر المسار $a \\to c \\to d$. $V_{ad} = V_{ac} - V_{dc} = 25V - 15V = 10V$.
6. **التحقق من تيار المقاومة R:**  التيار المار في المقاومة $R$ هو $I_R = V_{ad} / R = 10V / 2.5\\Omega = 4A$ (من a إلى d).
7. **التحقق من تيار البطارية السفلية $E_2$:** الجهد على طرفي هذا الفرع هو $V_{ad}=10V$. التيار المار فيه $I_{E2}$ يُحسب من: $V_{ad} = E_2 - I_{E2}r_2 \\implies 10 = 13 - I_{E2}(1) \\implies I_{E2} = 3A$ (من a إلى d).
8. **التيار المار في المقاومة $5\\Omega$**: من قانون كيرشوف للتيارات، نجد أن التيار المار من c إلى d هو  $I_{5\\Omega} = 3A$.
9. **فرق الجهد $V_{dc}$**: $V_{dc} = I_{5\\Omega} \\times 5\\Omega = 3A \\times 5\\Omega = 15V$.
10. **إيجاد R:** $R = V_{ad} / I_R = 10 / 4 = 2.5 \\Omega$.
`
  },
  {
    id: 10,
    questionText: "يمثّل المنحنى الخطي $I–V$ علاقة التيار بسلك فلزي عند درجة حرارة الغرفة. إذا انخفضت درجة حرارة السلك، فأيُّ منحنى يمثّل العلاقة بعد التبريد؟",
    options: [
      "خط مستقيم من الأصل بميل أصغر",
      "خط مستقيم من الأصل بميل أكبر",
      "منحنى متصاعد تقوّسه للأعلى (لاخطّي)",
      "منحنى يتشبّع عند تيارات كبيرة"
    ],
    correctAnswerIndex: 1,
