...
4. **التيار في المقاومة $5\\Omega$ ومنه $V_{dc}$**: عند العقدة $c$ تتجمّع تيارات الفرعين العلوي والأوسط وتتجه عبر المقاومة $5\\Omega$ نحو النقطة $d$. إذن: $I_{5\\Omega} = I_1 + I_2 = 1.25 + 5 = 6.25A$. (تصحيح: يجب تحليل التيارات عند العقدة d و a). لنفترض أن التيار في R هو $I_R$ والنيار في البطارية السفلية هو $I_{E2}$.
...
تحقق من عقدة a: $I_{in}=0$. $I_{out} = I_1+I_2+I_R+I_{E2} = 1.25+5+4+3=13.25A$. خطأ.`
  ...
  },
  {
    ...
    options: [
      'B تزداد إضاءته ، B1 تبقى ثابتة',
      'B تقل إضاءته ، B1 تزداد',
      'B تبقى ثابتة ، B1 تبقى ثابتة',
      'B تقل إضاءته ، B1 تبقى ثابتة',
    ],
    correctAnswerIndex: 0,
