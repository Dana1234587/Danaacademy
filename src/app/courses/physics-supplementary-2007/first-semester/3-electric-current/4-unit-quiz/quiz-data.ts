...
export const unit3QuizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    <div dir="rtl">
        ...
        <p>$P_{8\\Omega} = I^2 R = (0.5)^2 \\times 8 = 0.25 \\times 8 = 2 \\text{ J/s}$.</p>
        <br/>
        <b>ثانياً: إيجاد قيمة المقاومة $R$:</b>
        <ol style="list-style-type: decimal; padding-right: 20px;">
            <li>نحسب المقاومة الكلية للدائرة بين النقطتين a و b.</li>
            ...
            <li>الآن، نستخدم قانون التوصيل على التوازي لإيجاد $R$:</li>
