...
4. **التيار في المقاومة $5\\Omega$**: من قانون كيرشوف للتيارات عند النقطة c، التيار الداخل $I_1+I_2$ يجب أن يساوي التيار الخارج $I_{cd}$. $I_{cd} = 1.25 + 5 = 6.25A$. (تصحيح: يجب تحليل التيارات عند العقدة d و a). لنفترض أن التيار في R هو $I_R$ والنيار في البطارية السفلية هو $I_{E2}$.
