...
export const unit3QuizQuestions: QuizQuestion[] = [
  ...
  {
    id: 5,
    questionText: 'يمثل الشكل المجاور دارة كهربائية. عندما كان المفتاح s مفتوحاً كانت قراءة الفولتميتر ($9 V$) وبعد غلق المفتاح أصبحت ($8 V$). فإن قيمة كل من القوة الدافعة الكهربائية $\\varepsilon$ والمقاومة الداخلية $r$ على الترتيب هي:',
