...
الزوج المرتب المطلوب هو $(\\frac{I_2}{I_1}, \\frac{\\rho_2}{\\rho_1}) = (\\frac{4}{3}, 1)$.`,
  },
  {
    id: 3,
  ...
  },
  {
    ...
    correctAnswerIndex: 1,
    explanation: '1) المفتاح مفتوح: قراءة الفولتميتر هي جهد طرفي البطارية، وهو نفسه جهد المقاومة الخارجية $6\\Omega$. $V = 9V$ على $6\\Omega$ $\\Rightarrow I_1 = \\frac{V}{R} = \\frac{9}{6} = 1.5 A$. من علاقة جهد البطارية: $V = \\varepsilon - I_1 r \\Rightarrow 9 = \\varepsilon - 1.5r$ (معادلة 1).\n2) المفتاح مغلق: الآن $6\\Omega$ توازي $12\\Omega$. المقاومة المكافئة لهما: $\\frac{1}{R_{eq}} = \\frac{1}{6} + \\frac{1}{12} = \\frac{3}{12} \\Rightarrow R_{eq} = 4\\Omega$. قراءة الفولتميتر الآن $V=8V$ على هذه المجموعة: $I_2 = \\frac{V}{R_{eq}} = \\frac{8}{4} = 2A$. من علاقة جهد البطارية: $V = \\varepsilon - I_2 r \\Rightarrow 8 = \\varepsilon - 2r$ (معادلة 2).\n3) حل المعادلتين: نطرح (2) من (1): $(9-8) = (\\varepsilon - 1.5r) - (\\varepsilon - 2r) \\Rightarrow 1 = 0.5r \\Rightarrow r=2\\Omega$. نعوض في (2): $8 = \\varepsilon - 2(2) \\Rightarrow \\varepsilon = 12V$. النتيجة النهائية: $(r, \\varepsilon) = (2\\Omega, 12V)$.',
  },
  {
    id: 6,
