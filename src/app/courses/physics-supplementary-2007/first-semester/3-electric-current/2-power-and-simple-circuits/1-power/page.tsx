      ...
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <WatermarkedVideoPlayer src="https://iframe.mediadelivery.net/embed/480623/04e9bfe8-16e7-430e-8ed7-d1b5c50edfe9?autoplay=false&loop=false&muted=false&preload=true" />
                ...
                <Button variant="ghost" className="w-full justify-start">
                 ...
                 <Dialog>
                    ...
                    <DialogContent className="max-w-xl h-auto max-h-[80vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>ملخص قوانين: القدرة</DialogTitle>
                        </DialogHeader>
                        <SummaryPage />
                    </DialogContent>
                 </Dialog>
                 <Dialog>
                    ...
                    <DialogContent className="max-w-4xl h-[90vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>اختبار قصير: القدرة</DialogTitle>
                        </DialogHeader>
                        <QuizPage />
                    </DialogContent>
                 </Dialog>
