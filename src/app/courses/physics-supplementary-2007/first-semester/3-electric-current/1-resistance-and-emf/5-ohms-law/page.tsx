      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-2 max-w-2xl">
              تطبيقات وحل مسائل على قانون أوم، أحد أهم القوانين في الدارات الكهربائية.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <WatermarkedVideoPlayer src="https://iframe.mediadelivery.net/embed/480623/f17ff8e6-3f0d-4492-a2ac-ad6677ce0d0d?autoplay=false&loop=false&muted=false&preload=true" />
            ...
            <Card>
                ...
                <CardContent>
                    <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                        <li>تطبيق قانون أوم في دارات بسيطة.</li>
                        <li>حل مسائل باستخدام الرسوم البيانية (V-I).</li>
                        <li>ربط قانون أوم بقانون المقاومية.</li>
                    </ul>
                </CardContent>
            </Card>
          </div>
                ...
                <Button variant="ghost" className="w-full justify-start">
                 ...
                 <Dialog>
                    ...
                    <DialogContent className="max-w-xl h-auto max-h-[80vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>ملخص قوانين: قانون أوم</DialogTitle>
                        </DialogHeader>
                        <SummaryPage />
                    </DialogContent>
                 </Dialog>
