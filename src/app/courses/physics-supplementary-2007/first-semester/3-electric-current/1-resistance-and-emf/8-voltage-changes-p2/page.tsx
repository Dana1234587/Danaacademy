      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold mt-1">حصة رقم (8): تغيرات الجهد الكهربائي (الجزء الثاني)</h1>
            <p className="text-muted-foreground mt-2 max-w-2xl">
              في هذه الحصة، نواصل تعلم كيفية حساب تغيرات الجهد، بما في ذلك حالة شحن البطارية.
            </p>
          </div>
            ...
            <Card>
                ...
                <CardContent>
                    <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                        <li>حساب التغير في الجهد عبر بطارية (في حالة شحن).</li>
                        <li>مسائل متنوعة على حساب فرق الجهد بين نقطتين.</li>
                        <li>مفهوم جهد نقطة (إذا كانت هناك نقطة مؤرضة).</li>
                    </ul>
                </CardContent>
            </Card>
          </div>
              ...
              <CardContent className="space-y-3">
                ...
                <Dialog>
                    ...
                    <DialogContent className="max-w-xl h-auto max-h-[80vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>ملخص قوانين: تغيرات الجهد (الجزء الثاني)</DialogTitle>
                        </DialogHeader>
                        <SummaryPage />
                    </DialogContent>
                 </Dialog>
                 <Dialog>
                    ...
                    <DialogContent className="max-w-4xl h-[90vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>اختبار قصير: تغيرات الجهد (الجزء الثاني)</DialogTitle>
                        </DialogHeader>
                        <QuizPage />
                    </DialogContent>
                 </Dialog>
