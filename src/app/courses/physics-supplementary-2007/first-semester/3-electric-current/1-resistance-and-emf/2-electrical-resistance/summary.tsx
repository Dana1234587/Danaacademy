...
const laws = [
    {
        ...
        formula: "R = \\frac{V}{I}",
        description: "المقاومة هي خاصية للمادة تعيق مرور التيار الكهربائي. تُعرّف بأنها النسبة بين فرق الجهد (V) المطبق على الموصل وشدة التيار (I) المار فيه. وحدتها هي الأوم (Ω)."
    },
    {
        title: "قانون أوم",
        formula: "V = IR",
