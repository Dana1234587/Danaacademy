...
export default function ResistivityAdvancedQuestionsPage() {
  return (
      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-2 max-w-2xl">
              في هذه الحصة، نحل أسئلة متقدمة على المقاومة والمقاومية لترسيخ الفهم.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <WatermarkedVideoPlayer src="https://iframe.mediadelivery.net/embed/480623/f62fb162-6024-4d4b-a02b-37bb9f3f904b?autoplay=false&loop=false&muted=false&preload=true" />
            ...
            <Card>
                ...
                <CardContent>
                    <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                        <li>أسئلة تتضمن تغيير أبعاد الموصل (سحب السلك).</li>
                        <li>مسائل مقارنة بين موصلين مختلفين.</li>
                        <li>حل مسائل قدرات عليا من امتحانات سابقة.</li>
                    </ul>
                </CardContent>
            </Card>
          </div>
