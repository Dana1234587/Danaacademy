...
const quizQuestions = [
  ...
  {
    questionText: 'عند إضافة مقاومة جديدة على التوالي إلى مجموعة مقاومات، فإن المقاومة المكافئة...',
    options: ['تزداد', 'تقل', 'تبقى ثابتة', 'تعتمد على قيمة البطارية'],
    correctAnswerIndex: 0,
    explanation: 'عند التوصيل على التوالي، المقاومة المكافئة هي المجموع. إضافة أي مقاومة جديدة ستزيد من المجموع الكلي، وبالتالي تزداد المقاومة المكافئة.'
  },
];

export default function ResistorConnectionsQuizPage() {
