...
export const ComplexCircuitDiagram = () => (
    <div className="my-4 p-4 bg-muted rounded-lg flex justify-center items-center">
        <svg width="300" height="200" viewBox="0 0 300 200">
            ...
            <line x1="30" y1="20" x2="30" y2="60" stroke="black" strokeWidth="1.5"/>
            ...
            <g transform="translate(180, 20)"><Switch x={0} y={0} open={false} /></g>
            
            {/* Bottom Branch */}
            <line x1="30" y1="180" x2="100" y2="180" stroke="black" strokeWidth="1.5"/>
            <g transform="translate(100, 180)"><Resistor x={0} y={0} label="R2" /></g>
