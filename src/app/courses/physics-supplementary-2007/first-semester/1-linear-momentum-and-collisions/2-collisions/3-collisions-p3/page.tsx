...
export default function CollisionsP3Page() {
  return (
      ...
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <WatermarkedVideoPlayer src="https://iframe.mediadelivery.net/embed/480623/6ee14818-52de-4bc8-99ba-d85e08dbb7b8?autoplay=false&loop=false&muted=false&preload=true" />
