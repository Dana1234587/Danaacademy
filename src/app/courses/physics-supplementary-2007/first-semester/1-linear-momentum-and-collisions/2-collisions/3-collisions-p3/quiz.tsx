...
const quizQuestions = [
  ...
  {
    questionText: 'كرة كتلتها 2 كجم تتحرك بسرعة 3 م/ث تصطدم بكرة أخرى ساكنة كتلتها 1 كجم. إذا كان التصادم مرنًا، ما هي سرعة الكرة الثانية بعد التصادم؟',
  ...
  {
    questionText: 'سيارة كتلتها 1000 كجم تتحرك بسرعة 20 م/ث تصطدم بسيارة أخرى ساكنة وتلتحمان. إذا كانت سرعتهما المشتركة 8 م/ث، فما كتلة السيارة الثانية؟',
