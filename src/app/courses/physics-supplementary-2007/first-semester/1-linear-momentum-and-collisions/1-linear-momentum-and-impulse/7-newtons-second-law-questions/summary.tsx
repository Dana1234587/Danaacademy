       ...
       <div className="space-y-6">
        {laws.map((law, index) => (
         ...
         <Alert>
          ...
          <AlertDescription>
           <SmartTextRenderer as="div" text={'عند حل أي سؤال، حدد المعطيات والمطلوب. إذا كان المطلوب هو القوة، فغالبًا ستحتاج لحساب التغير في الزخم الخطي أولًا. إذا كانت المسألة تتعلق بالارتداد، فكن حذرًا جدًا في تحديد اتجاه موجب واعتبار السرعة المرتدة سالبة.'} />
          </AlertDescription>
        </Alert>
      </div>
    </div>
