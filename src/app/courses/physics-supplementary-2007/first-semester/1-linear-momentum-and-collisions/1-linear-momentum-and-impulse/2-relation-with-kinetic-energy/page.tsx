      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold mt-1">حصة رقم (2): العلاقة مع طاقة الحركة</h1>
            <p className="text-muted-foreground mt-2 max-w-2xl">
              في هذه الحصة، نستكشف العلاقة بين الزخم الخطي وطاقة الحركة، وكيف يمكننا التفريق بينهما.
            </p>
          </div>
            ...
            <Card>
                ...
                <CardContent>
                    <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                        <li>الفرق بين الزخم الخطي وطاقة الحركة.</li>
                        <li>الصيغ الرياضية التي تربط بين الزخم وطاقة الحركة.</li>
                        <li>متى يكون لجسمين نفس الزخم ولكن طاقة حركة مختلفة؟</li>
                        <li>أمثلة حسابية لتوضيح العلاقة.</li>
                    </ul>
                </CardContent>
            </Card>
          </div>
