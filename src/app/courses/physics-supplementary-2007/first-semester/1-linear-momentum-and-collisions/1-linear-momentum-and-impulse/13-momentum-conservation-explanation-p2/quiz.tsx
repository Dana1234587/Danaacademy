...
const quizQuestions = [
  ...
  {
    questionText: 'جسم كتلته $m_1$ يتحرك بسرعة $v_{1i}$ يصطدم بجسم آخر ساكن كتلته $m_2$. إذا التحما معًا بعد التصادم، فما سرعتهما النهائية المشتركة $v_f$؟',
    options: ['$v_f = \\frac{m_1}{m_2}v_{1i}$', '$v_f = \\frac{m_1+m_2}{m_1}v_{1i}$', '$v_f = \\frac{m_1}{m_1+m_2}v_{1i}$', '$v_f = v_{1i}$'],
    correctAnswerIndex: 2,
    explanation: 'هذا تصادم عديم المرونة. نطبق قانون حفظ الزخم الخطي: $\\Sigma p_i = \\Sigma p_f$. \n $m_1 v_{1i} + m_2 v_{2i} = (m_1+m_2)v_f$. \n بما أن الجسم الثاني ساكن، $v_{2i}=0$. \n $m_1 v_{1i} = (m_1+m_2)v_f$. \n بقسمة الطرفين على $(m_1+m_2)$, نحصل على $v_f = \\frac{m_1}{m_1+m_2}v_{1i}$.'
  },
  {
