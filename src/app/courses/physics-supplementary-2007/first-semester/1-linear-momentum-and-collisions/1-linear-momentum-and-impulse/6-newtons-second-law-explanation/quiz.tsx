...
const quizQuestions = [
  ...
  {
    questionText: 'عربة رملية تتحرك على مسار أفقي بسرعة ثابتة، وبدأ الرمل يتسرب من ثقب في قاعها. لإبقاء العربة تتحرك بنفس السرعة الثابتة، يجب أن تكون القوة الأفقية الخارجية...',
    options: ['متزايدة', 'متناقصة', 'تساوي صفرًا', 'ثابتة وغير صفرية'],
    correctAnswerIndex: 2,
    explanation: 'بما أن السرعة ثابتة والكتلة تتناقص، فإن الزخم الخطي ($p=mv$) للعربة يتناقص. لكي يتناقص الزخم، يجب أن تؤثر قوة محصلة معاكسة لاتجاه الحركة ($\Sigma F = \\frac{\\Delta p}{\\Delta t}$، وهنا $\Delta p$ سالب). ولكن السؤال يطلب القوة اللازمة للحفاظ على سرعة ثابتة. بما أن لا يوجد احتكاك، والسرعة ثابتة (تسارع صفر)، فإن القوة المحصلة يجب أن تكون صفرًا. تسرب الرمل لا يؤثر على الحركة الأفقية في هذه الحالة المثالية.'
  },
];
