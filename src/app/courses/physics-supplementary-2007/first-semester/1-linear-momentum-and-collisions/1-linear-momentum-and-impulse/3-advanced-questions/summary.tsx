       ...
       <div className="space-y-6">
        {laws.map((law, index) => (
         ...
         <Alert>
          ...
          <AlertDescription>
           <p className="text-right">تخيل شاحنة وسيارة صغيرتان تتحركان بنفس الزخم الخطي. لإيقافهما، نحتاج إلى نفس الدفع لأن التغير في الزخم $\\Delta p$ متساوٍ. لكن الشاحنة ذات الكتلة الأكبر تمتلك طاقة حركية أقل، وبالتالي فإن الضرر الناتج عنها سيكون أقل من السيارة الأسرع ذات الكتلة الأصغر التي تمتلك طاقة حركية أكبر.</p>
          </AlertDescription>
        </Alert>
      </div>
    </div>
