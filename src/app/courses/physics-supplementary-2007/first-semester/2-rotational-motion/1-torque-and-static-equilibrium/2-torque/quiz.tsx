...
const quizQuestions = [
  ...
  {
    questionText: 'وفقًا لقاعدة اليد اليمنى، إذا كانت أصابعك تلتف مع اتجاه الدوران الذي يسببه العزم، فإلى ماذا يشير إبهامك؟',
    options: ['اتجاه القوة', 'اتجاه ذراع القوة', 'اتجاه متجه العزم', 'اتجاه السرعة الزاوية'],
    correctAnswerIndex: 2,
    explanation: 'قاعدة اليد اليمنى هي الطريقة القياسية لتحديد اتجاه المتجه الناتج عن الضرب المتجهي. في حالة العزم، التفاف الأصابع مع اتجاه الدوران يجعل الإبهام يشير إلى اتجاه متجه العزم.'
  },
  {
