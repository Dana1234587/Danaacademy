...
const quizQuestions = [
  ...
  {
    questionText: 'عندما تقذف مفتاح ربط في الهواء بحيث يدور، فإن النقطة التي تتبع مسار قطع مكافئ منتظم هي:',
    options: ['الطرف الأثقل للمفتاح', 'الطرف الأخف للمفتاح', 'مركز كتلة المفتاح', 'جميع نقاط المفتاح'],
    correctAnswerIndex: 2,
    explanation: 'بينما تدور جميع نقاط الجسم حول مركز الكتلة، فإن مركز الكتلة نفسه يتبع مسارًا بسيطًا (قطع مكافئ في هذه الحالة) كما لو كان جسيمًا نقطيًا تؤثر عليه الجاذبية.'
  },
];
