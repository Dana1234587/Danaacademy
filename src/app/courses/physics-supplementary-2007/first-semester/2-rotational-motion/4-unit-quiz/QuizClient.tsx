...
const QUIZ_DURATION_SECONDS = 75 * 60; // 75 minutes
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                    <div className="bg-muted/50 p-4 rounded-lg">
                     ...
                     <div className="bg-muted/50 p-4 rounded-lg">
                        ...
                        <p className="text-muted-foreground"><SmartTextRenderer as="span" text={`$75$ دقيقة`} /></p>
                    </div>
                     <div className="bg-muted/50 p-4 rounded-lg">
                 ...
                 <Alert variant="destructive" className="bg-destructive/5 border-destructive/20">
                    ...
                    <AlertDescription>
                        <ul className="list-disc list-outside space-y-2 mt-2 pe-4">
                            ...
                            <li className="flex items-start gap-2"><BookOpen className="w-4 h-4 mt-1" /><span>للحصول على تقييم دقيق، تأكد من مراجعتك الكاملة لوحدة "الحركة الدورانية".</span></li>
                        </ul>
                    </AlertDescription>
                </Alert>
            </CardContent>
