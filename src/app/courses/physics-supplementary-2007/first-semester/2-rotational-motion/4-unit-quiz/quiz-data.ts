...
الجواب الصحيح هو (أ) تقل.`,
  },
  {
      ...
      options: ['أ', 'ب', 'ج', 'د'],
      correctAnswerIndex: 0,
      explanation: `للتحقيق من الاتزان، مجموع العزوم حول نقطة الارتكاز يجب أن يكون صفراً. عزم القوة F1 هو 120 نيوتن.متر (عكس اتجاه عقارب الساعة). وعزم القوة F2 هو F2*6 (مع اتجاه عقارب الساعة). بالتالي F2 يجب أن تكون 20 نيوتن.`,
  },
  {
      id: 5,
      questionText: `اختر رمز الإجابة الصحيحة`,
