...
export const unit2QuizQuestions: QuizQuestion[] = [
  {
    ...
    image: 'https://i.ibb.co/Xr1bh47/1.png',
...
*   **القوى المؤثرة:** عندما يتحرك الطفل نحو المركز، فإن القوة التي تحركه هي قوة **داخلية** ضمن النظام. لا توجد عزوم خارجية محصلة تؤثر على دوران النظام.
*   **القانون الحاكم:** بما أنه لا يوجد عزم خارجي محصل، فإن **الزخم الزاوي (L) للنظام يبقى محفوظًا (ثابتًا)**.
    *   $L_{\\text{initial}} = L_{\\text{final}}$

**2. تحليل الحالة الابتدائية والنهائية:**
*   **الزخم الزاوي (L):** يُعطى بالعلاقة $L = I \\times \\omega$، حيث $I$ هو عزم القصور الذاتي و $\\omega$ هي السرعة الزاوية.
*   **عزم القصور الذاتي (I):** يعتمد على توزيع الكتلة حول محور الدوران. كلما ابتعدت الكتلة عن المحور، زاد عزم القصور الذاتي ($I \\propto mr^2$).
*   **الحالة الابتدائية:** كان الأطفال الثلاثة عند حافة القرص، مما يعني أن عزم القصور الذاتي للنظام $I_{\\text{initial}}$ كان في قيمته القصوى.
*   **الحالة النهائية:** تحرك الطفل ذو الكتلة $20\\text{kg}$ إلى المركز ($r = 0$). هذا يعني أن جزءًا من كتلة النظام اقترب بشكل كبير من محور الدوران.
*   **النتيجة على عزم القصور (I):** عندما تقترب الكتلة من المحور، **يقل** عزم القصور الذاتي الكلي للنظام. إذن: $I_{\\text{final}} < I_{\\text{initial}}$.
