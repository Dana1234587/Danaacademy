...
الإجابة: $1.92 \\text{ N.m}$ عكس عقارب الساعة (الخيار د).`,
  },
  {
      id: 6,
      questionText: `اختر رمز الإجابة الصحيحة`,
      ...
      options: ['أ', 'ب', 'ج', 'د'],
      correctAnswerIndex: 2,
      explanation: `نختار عكس عقارب الساعة موجبًا.

من القوة $10 \\text{ N}$ عند أعلى الحافة: اتجاهها مماسي (عمودي على نصف القطر)، إذن
$\\tau_{10} = - F b = -(10)(0.25) = -2.50 \\text{ N.m}$
(سالب لأنها تُدير مع عقارب الساعة).

من القوة $9 \\text{ N}$ عند يمين الحافة: أيضًا مماسي:
$\\tau_9 = -(9)(0.25) = -2.25 \\text{ N.m}$

من القوة $12 \\text{ N}$ عند نصف القطر $a$ وميل $30^\\circ$ مع نصف القطر:
$\\tau_{12} = r F \\sin(\\theta) = (0.10)(12)\\sin(30^\\circ) = (0.10)(12)(0.5) = +0.60 \\text{ N.m}$
(موجب لأنها تعاكس الدوران السابق).

العزم المحصّل:
$\\tau_{net} = \\tau_{10} + \\tau_9 + \\tau_{12} = -2.50 - 2.25 + 0.60 = -4.15 \\text{ N.m}$
الإشارة السالبة ⇒ مع عقارب الساعة.

الإجابة: $4.15 \\text{ N.m}$ مع عقارب الساعة (تطابق الخيار ج).`,
  },
  {
      id: 7,
      questionText: `اختر رمز الإجابة الصحيحة`,
      ...
      options: ['أ', 'ب', 'ج', 'د'],
      correctAnswerIndex: 1,
      explanation: `العزم حول $A$ يساوي:
$\\tau = r F \\sin(\\phi)$
حيث $r = L$ هو نصف القطر (المسافة من $A$ إلى نقطة تأثير القوة)، و$\\phi$ الزاوية بين اتجاه القضيب والقوة.
القضيب يصنع زاوية $\\theta$ مع الأفقي، والقوة $P$ رأسية، إذن
$\\phi = 90^\\circ - \\theta \\implies \\sin(\\phi) = \\sin(90^\\circ - \\theta) = \\cos(\\theta)$.
إذًا:
...
الإجابة الصحيحة: (ب) $PL\\cos(\\theta)$.`,
  },
  {
      ...
      options: ['أ', 'ب', 'ج', 'د'],
      correctAnswerIndex: 1,
      explanation: `مركز الدوران عند النقطة $O$.
...
هنا نقطة تأثير القوة على المحور نفسه $\\implies r = 0$ (و $d_\\perp = 0$) بغضّ النظر عن طول العصا أو زاوية $60^\\circ$.

$\\tau = 0 \\times 10 \\times \\sin(60^\\circ) = 0 \\text{ N.m}$

الإجابة الصحيحة: (ب) $0 \\text{ N.m}$

ملاحظة: طول العصا $400 \\text{ cm}$ والزاوية $60^\\circ$ وضِعا للتشتيت؛ العزم يساوي صفرًا لأن خط عمل القوة يمرّ بمحور الدوران.`
  },
  {
      id: 9,
      questionText: `اختر رمز الإجابة الصحيحة`,
