      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold mt-1">بنية النواة</h1>
            <p className="text-muted-foreground mt-2 max-w-2xl">
              في هذه الحصة، نتعرف على مكونات النواة والرموز المستخدمة لوصفها.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <WatermarkedVideoPlayer src="https://iframe.mediadelivery.net/embed/480623/ca7e44cb-ffcb-4704-b8b3-0edaee11861c?autoplay=false&loop=false&muted=false&preload=true" />
            ...
            <Card>
                ...
                <CardContent>
                    <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                        <li>مكونات النواة (البروتونات والنيوترونات).</li>
                        <li>العدد الذري، العدد الكتلي، وعدد النيوترونات.</li>
                        <li>مفهوم النظائر.</li>
                    </ul>
                </CardContent>
            </Card>
              ...
              <CardContent className="space-y-3">
                ...
                <Dialog>
                    ...
                    <DialogContent className="max-w-xl h-auto max-h-[80vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>ملخص قوانين: بنية النواة</DialogTitle>
                        </DialogHeader>
                        <SummaryPage />
                    </DialogContent>
                 </Dialog>
