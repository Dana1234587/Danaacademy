      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold mt-1">قوانين متعلقة بشكل النواة</h1>
            <p className="text-muted-foreground mt-2 max-w-2xl">
              في هذه الحصة، ندرس القوانين المتعلقة بنصف قطر النواة وحجمها وكثافتها.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <WatermarkedVideoPlayer src="https://iframe.mediadelivery.net/embed/480623/ca95fb29-b7b9-4028-8c0a-6919a526fbef?autoplay=false&loop=false&muted=false&preload=true" />
            ...
            <Card>
                ...
                <CardContent>
                    <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                        <li>العلاقة بين نصف قطر النواة والعدد الكتلي.</li>
                        <li>حساب حجم النواة.</li>
                        <li>إثبات أن كثافة النواة ثابتة تقريبًا لجميع العناصر.</li>
                    </ul>
                </CardContent>
            </Card>
          </div>
