      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold mt-1">طاقة الربط النووية</h1>
            <p className="text-muted-foreground mt-2 max-w-2xl">
              في هذه الحصة، ندرس مفهوم طاقة الربط النووية وعلاقتها باستقرار النواة.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <WatermarkedVideoPlayer src="https://iframe.mediadelivery.net/embed/480623/63f53739-92e0-495a-b756-9e05fef57169?autoplay=false&loop=false&muted=false&preload=true" />
            ...
            <Card>
                ...
                <CardContent>
                    <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                        <li>فرق الكتلة وتكافؤ الكتلة والطاقة.</li>
                        <li>حساب طاقة الربط النووية.</li>
                        <li>منحنى طاقة الربط لكل نيوكليون وعلاقته بالاستقرار.</li>
                    </ul>
                </CardContent>
            </Card>
          </div>
