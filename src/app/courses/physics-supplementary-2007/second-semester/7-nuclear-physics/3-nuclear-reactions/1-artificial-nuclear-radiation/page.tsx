    ...
    <div className="min-h-screen bg-muted/40">
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            <p className="text-sm text-primary font-medium">الدرس الثالث: التفاعلات النووية</p>
            <h1 className="text-3xl font-bold mt-1">الاشعاع النووي الصناعي</h1>
            <p className="text-muted-foreground mt-2 max-w-2xl">
              في هذه الحصة، ندرس التفاعلات النووية الصناعية والانشطار والاندماج النووي.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <WatermarkedVideoPlayer src="https://iframe.mediadelivery.net/embed/480623/5650443b-a7bd-477e-be3c-04553424f45c?autoplay=false&loop=false&muted=false&preload=true" />
            ...
            <Card>
                ...
                <CardContent>
                    <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                        <li>مفهوم التفاعلات النووية.</li>
                        <li>الانشطار النووي وتطبيقاته.</li>
                        <li>الاندماج النووي ومصدر طاقة النجوم.</li>
                    </ul>
                </CardContent>
            </Card>
          </div>
