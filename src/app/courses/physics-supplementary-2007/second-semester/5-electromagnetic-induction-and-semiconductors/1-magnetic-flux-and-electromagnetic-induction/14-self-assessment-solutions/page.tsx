      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-2 max-w-2xl">
              في هذه الحصة، نقوم بحل أسئلة "اختبر نفسك" من الكتاب.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <WatermarkedVideoPlayer src="https://iframe.mediadelivery.net/embed/480623/dd1cfe9e-e80e-49b9-8030-fd38813c44ff?autoplay=false&loop=false&muted=false&preload=true" />
