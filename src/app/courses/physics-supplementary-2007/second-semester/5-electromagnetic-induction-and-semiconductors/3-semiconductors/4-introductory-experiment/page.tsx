      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold mt-1">التجربة الاستهلالية</h1>
            <p className="text-muted-foreground mt-2 max-w-2xl">
              في هذه الحصة، نشاهد تجربة عملية توضح خصائص أشباه الموصلات.
            </p>
          </div>
            ...
            <Card>
                ...
                <CardContent>
                    <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                        <li>مشاهدة تجربة عملية على الثنائي.</li>
                        <li>تأثير الحرارة على مقاومة شبه الموصل.</li>
                        <li>مقارنة بين سلوك الموصل وشبه الموصل.</li>
                    </ul>
                </CardContent>
            </Card>
          </div>
              ...
              <CardContent className="space-y-3">
                ...
                <Dialog>
                    ...
                    <DialogContent className="max-w-xl h-auto max-h-[80vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>ملخص التجربة الاستهلالية</DialogTitle>
                        </DialogHeader>
                        <SummaryPage />
                    </DialogContent>
                 </Dialog>
