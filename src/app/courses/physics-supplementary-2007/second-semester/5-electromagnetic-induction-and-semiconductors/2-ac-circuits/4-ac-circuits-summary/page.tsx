      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold mt-1">دارات التيار المتردد ملخص قوانين الدرس</h1>
            <p className="text-muted-foreground mt-2 max-w-2xl">
              في هذه الحصة، نراجع ونلخص جميع القوانين المهمة في دارات التيار المتردد.
            </p>
          </div>
            ...
            <Card>
                ...
                <CardContent>
                    <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                        <li>ملخص شامل لقوانين المفاعلة والمعاوقة.</li>
                        <li>مراجعة قوانين القيمة الفعالة والقدرة.</li>
                        <li>خرائط مفاهيمية لربط الأفكار.</li>
                    </ul>
                </CardContent>
            </Card>
          </div>
                ...
                <Dialog>
                 ...
                 <Dialog>
                    ...
                    <DialogContent className="max-w-4xl h-[90vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>اختبار قصير: ملخص دارات التيار المتردد</DialogTitle>
                        </DialogHeader>
                        <QuizPage />
                    </DialogContent>
                 </Dialog>
