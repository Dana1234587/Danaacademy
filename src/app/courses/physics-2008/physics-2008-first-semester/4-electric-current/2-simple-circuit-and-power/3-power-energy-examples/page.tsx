...
export default function PowerEnergyExamplesPage() {
    return (
            ...
            <div className="p-4 sm:p-6 lg:p-8">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                    <div>
                        ...
                        <h1 className="text-3xl font-bold mt-1">حصة رقم (3): القدرة والطاقة الكهربائية (حل أمثلة إضافية)</h1>
                        <p className="text-muted-foreground mt-2 max-w-2xl">
                            في هذه الحصة، نحل أمثلة إضافية ومتنوعة على القدرة والطاقة الكهربائية.
                        </p>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 space-y-6">
                        <WatermarkedVideoPlayer src="https://vz-2adfd2e0-f8c.b-cdn.net/a2001015-92e4-49a0-b2b4-3b939c7176c5/playlist.m3u8" />
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                                    <li>تطبيقات متنوعة على قوانين القدرة الكهربائية.</li>
                                    <li>حل مسائل على الطاقة المستهلكة بوحدات مختلفة.</li>
                                    <li>تحويل الوحدات بين الجول والكيلو واط ساعة.</li>
                                </ul>
                            </CardContent>
                        </Card>
                    </div>
