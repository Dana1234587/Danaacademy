            ...
            <div className="p-4 sm:p-6 lg:p-8">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                    <div>
                        ...
                        <h1 className="text-3xl font-bold mt-1">حصة رقم (2): الدارات الكهربائية البسيطة</h1>
                        <p className="text-muted-foreground mt-2 max-w-2xl">
                            في هذه الحصة، ندرس معادلة الدارة البسيطة وقانون التيار الرئيسي والقدرة الكهربائية.
                        </p>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 space-y-6">
                        <WatermarkedVideoPlayer src="https://vz-2adfd2e0-f8c.b-cdn.net/9663be4d-1005-4d5a-ac58-f4fff521291b/playlist.m3u8" />
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                                    <li>الدارة البسيطة: دارة لا يتفرع فيها التيار.</li>
                                    <li>معادلة الدارة: ε = Ir + IR</li>
                                    <li>التيار الرئيسي: I = Σε / (Σr + Req)</li>
                                    <li>قراءة الفولتميتر حسب موقعه (بطارية أو مقاومة).</li>
                                </ul>
                            </CardContent>
                        </Card>
                    </div>
