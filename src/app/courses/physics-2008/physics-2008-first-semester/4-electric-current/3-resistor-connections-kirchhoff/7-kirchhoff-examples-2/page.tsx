...
import QuizPage from '../6-kirchhoff-examples-1/quiz';
import SummaryPage from '../5-kirchhoff-second-rule/summary';
import WatermarkedVideoPlayer from '@/components/watermarked-video-player';

export default function KirchhoffExamples2Page() {
    return (
            ...
            <div className="p-4 sm:p-6 lg:p-8">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                    <div>
                        ...
                        <h1 className="text-3xl font-bold mt-1">حصة رقم (7): قاعدتا كيرتشوف (حل أمثلة إضافية 2)</h1>
                        <p className="text-muted-foreground mt-2 max-w-2xl">
                            في هذه الحصة، نكمل حل أمثلة إضافية على قاعدتي كيرتشوف في الدارات المعقدة.
                        </p>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 space-y-6">
                        <WatermarkedVideoPlayer src="https://vz-2adfd2e0-f8c.b-cdn.net/b8999eef-5afd-4843-86ac-74594fb1a903/playlist.m3u8" />
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                                    <li>مسائل متقدمة على الدارات المعقدة.</li>
                                    <li>حساب فرق الجهد بين نقطتين.</li>
                                    <li>تحليل دارات متعددة البطاريات.</li>
                                </ul>
                            </CardContent>
                        </Card>
                    </div>
