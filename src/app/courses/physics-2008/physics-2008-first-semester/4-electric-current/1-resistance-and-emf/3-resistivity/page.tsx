                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-2 max-w-2xl">
                            في هذه الحصة، نتعرف على المقاومية وتعريفها، والفرق بينها وبين المقاومة، والعوامل المؤثرة على كل منهما.
                        </p>
                    </div>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                                    <li>تعريف المقاومية: مقاومة موصل طوله 1m ومساحة مقطعه 1m².</li>
                                    <li>المقاومية تعتمد على نوع المادة ودرجة الحرارة فقط.</li>
                                    <li>المقاومية لا تتأثر بالأبعاد الهندسية (الطول والمساحة).</li>
                                    <li>المقاومة تتأثر بالأبعاد الهندسية والحرارة ونوع المادة.</li>
                                    <li>وحدة المقاومية: أوم·متر (Ω·m).</li>
                                </ul>
                            </CardContent>
                        </Card>
                    </div>
                            ...
                            <CardContent className="space-y-3">
                                ...
                                <Dialog>
                                    ...
                                    <DialogContent className="max-w-4xl h-auto max-h-[85vh] overflow-y-auto">
                                        <DialogHeader>
                                            <DialogTitle>ملخص: المقاومية</DialogTitle>
                                        </DialogHeader>
                                        <SummaryPage />
                                    </DialogContent>
                                </Dialog>
