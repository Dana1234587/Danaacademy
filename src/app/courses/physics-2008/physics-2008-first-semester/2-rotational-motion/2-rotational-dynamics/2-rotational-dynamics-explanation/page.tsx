...
export default function RotationalDynamicsExplanationPage() {
  return (
      ...
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <WatermarkedVideoPlayer src="https://iframe.mediadelivery.net/embed/480623/05169f8c-cfab-438a-8473-fa290489ae6c?autoplay=false&loop=false&muted=false&preload=true" />
            <Card>
                <CardHeader>
              ...
              <CardContent className="space-y-3">
                ...
                <Dialog>
                    ...
                    <DialogContent className="max-w-xl h-auto max-h-[80vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>ملخص قوانين: ديناميكا الحركة الدورانية</DialogTitle>
                        </DialogHeader>
                        <SummaryPage />
                    </DialogContent>
                 </Dialog>
                 <Dialog>
                    ...
                    <DialogContent className="max-w-4xl h-[90vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>اختبار قصير: ديناميكا الحركة الدورانية</DialogTitle>
                        </DialogHeader>
                        <QuizPage />
                    </DialogContent>
                 </Dialog>
