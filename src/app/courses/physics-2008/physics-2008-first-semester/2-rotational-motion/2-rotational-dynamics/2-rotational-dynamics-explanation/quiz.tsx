...
const quizQuestions = [
  ...
  {
    questionText: 'عجلة تدور بسرعة زاوية ثابتة مقدارها $4 rad/s$. ما مقدار الإزاحة الزاوية التي تقطعها خلال 10 ثوانٍ؟',
    options: ['40 rad', '2.5 rad', '0.4 rad', '400 rad'],
    correctAnswerIndex: 0,
    explanation: 'بما أن السرعة الزاوية ثابتة، فإن الإزاحة الزاوية ($\\Delta\\theta$) تساوي حاصل ضرب السرعة الزاوية ($\\omega$) في الزمن (t). \\n $\\Delta\\theta = \\omega \\times t = 4 rad/s \\times 10 s = 40$ rad.'
  },
  {
