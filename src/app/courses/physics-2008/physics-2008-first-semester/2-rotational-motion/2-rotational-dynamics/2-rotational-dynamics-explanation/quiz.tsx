...
const quizQuestions = [
  ...
  {
    questionText: 'إذا كانت الإزاحة الزاوية لجسم تُعطى بالعلاقة $θ(t) = 2t^3 - 4t$. ما هي السرعة الزاوية اللحظية عند $t=2s$؟',
    options: ['8 rad/s', '16 rad/s', '20 rad/s', '24 rad/s'],
    correctAnswerIndex: 2,
    explanation: 'السرعة الزاوية اللحظية هي مشتقة الإزاحة الزاوية بالنسبة للزمن. \n $ω(t) = \\frac{dθ}{dt} = 6t^2 - 4$. \n عند $t=2s$: $ω(2) = 6(2)^2 - 4 = 24 - 4 = 20$ rad/s.'
  },
  {
