...
const quizQuestions = [
  ...
  },
  {
    ...
    explanation: 'نطبق قانون مركز الكتلة: $x_{cm} = \\frac{m_1x_1 + m_2x_2}{m_1 + m_2}$.\nبالتعويض: $\\frac{d}{3} = \\frac{m_1(0) + m_2(d)}{m_1 + m_2}$.\n$\\frac{d}{3} = \\frac{m_2 d}{m_1 + m_2}$.\nبقسمة الطرفين على d:\n$\\frac{1}{3} = \\frac{m_2}{m_1 + m_2}$.\n$m_1 + m_2 = 3m_2 \\implies m_1 = 2m_2$.\nالنسبة المطلوبة هي $\\frac{m_2}{m_1} = \\frac{1}{2}$.'
  },
];
