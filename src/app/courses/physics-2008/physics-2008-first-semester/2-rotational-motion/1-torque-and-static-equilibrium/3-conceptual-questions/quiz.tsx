...
const quizQuestions = [
  ...
  {
    questionText: 'تؤثر قوة مقدارها 50 نيوتن على رافعة على بعد 20 سم من محور الدوران. إذا كانت الزاوية بين القوة والرافعة 30 درجة، فما مقدار العزم المؤثر؟',
    options: ['$5 N \\cdot m$', '$8.66 N \\cdot m$', '$10 N \\cdot m$', '$500 N \\cdot m$'],
    correctAnswerIndex: 0,
    explanation: 'العزم $τ = rF\\sin(θ)$. يجب تحويل المسافة إلى متر: $r = 20 cm = 0.2 m$. \n $τ = (0.2 m)(50 N)\\sin(30^\\circ) = 10 \\times 0.5 = 5 N \\cdot m$.'
  },
  {
    questionText: 'قوة F تؤثر على مسافة r من محور الدوران، وتصنع زاوية θ مع ذراع القوة. أي من الصيغ التالية تمثل مقدار العزم؟',
    options: ['$τ = Fr\\cos(θ)$', '$τ = Fr\\tan(θ)$', '$τ = Fr\\sin(θ)$', '$τ = F/r$'],
    correctAnswerIndex: 2,
    explanation: 'الصيغة الأساسية لحساب مقدار العزم هي حاصل ضرب مقدار القوة في مقدار ذراعها في جيب الزاوية بينهما، أي $τ = rF\\sin(θ)$.'
  },
  {
