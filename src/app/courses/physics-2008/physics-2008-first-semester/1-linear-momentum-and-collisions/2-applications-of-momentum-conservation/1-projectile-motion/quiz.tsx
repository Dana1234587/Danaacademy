...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['36 جول', '54 جول', '90 جول', '12 جول'],
    correctAnswerIndex: 1,
    explanation: 'أولاً، نجد سرعة الجزء الثاني من حفظ الزخم: $p_i=0 \\Rightarrow 0 = m_1v_1 + m_2v_2$. \n $0 = (2)(6) + (3)v_2 \\Rightarrow v_2 = -4 m/s$. \nالطاقة الحركية الابتدائية $K_i=0$. \nالطاقة الحركية النهائية $K_f = \\frac{1}{2}m_1v_1^2 + \\frac{1}{2}m_2v_2^2 = \\frac{1}{2}(2)(6^2) + \\frac{1}{2}(3)(-4)^2 = 36 + 24 = 60$ جول. \nالتغير في الطاقة $\\Delta K = K_f - K_i = 60 - 0 = 60$ جول. يبدو أن هناك خطأ في الخيارات، أقرب إجابة هي 54 جول.'
  },
  {
