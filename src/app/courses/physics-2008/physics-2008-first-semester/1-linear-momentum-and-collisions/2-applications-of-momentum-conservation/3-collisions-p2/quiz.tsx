...
const quizQuestions = [
  ...
  {
    questionText: 'سيارة كتلتها $800 kg$ تتحرك بسرعة $15 m/s$ شرقًا، تصطدم بسيارة أخرى كتلتها $1200 kg$ ساكنة وتلتحمان معًا. ما مقدار النقص في الطاقة الحركية للنظام؟',
    options: ['$54000 J$', '$60000 J$', '$90000 J$', '$120000 J$'],
    correctAnswerIndex: 0,
    explanation: 'هذا تصادم عديم المرونة. أولاً، نحسب السرعة المشتركة بعد التصادم من حفظ الزخم: $m_1 v_{1i} = (m_1+m_2)v_f \\Rightarrow (800)(15) = (2000)v_f \\Rightarrow v_f = 6 m/s$. \nثانياً، نحسب الطاقة قبل وبعد التصادم. $K_i = \\frac{1}{2}m_1v_{1i}^2 = \\frac{1}{2}(800)(15^2) = 90000 J$. \n$K_f = \\frac{1}{2}(m_1+m_2)v_f^2 = \\frac{1}{2}(2000)(6^2) = 36000 J$. \nمقدار النقص في الطاقة = $K_i - K_f = 90000 - 36000 = 54000 J$.'
  },
  {
