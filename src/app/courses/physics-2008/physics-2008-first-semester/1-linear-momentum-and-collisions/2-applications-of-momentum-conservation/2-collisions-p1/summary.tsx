...
const laws = [
    ...
    },
    {
        ...
        formula: "\\vec{v}_{1i} + \\vec{v}_{1f} = \\vec{v}_{2i} + \\vec{v}_{2f}",
       ...
       <div className="space-y-6">
        {laws.map((law, index) => (
         ...
         <Alert>
          ...
          <AlertDescription>
            عند حل مسائل التصادم المرن، يمكنك استخدام معادلة حفظ الزخم مع معادلة علاقة السرعة النسبية كنظام من معادلتين لحل مجهولين (مثل السرعات النهائية). تذكر الانتباه جيدًا لإشارات السرعة التي تدل على الاتجاه.
          </AlertDescription>
        </Alert>
      </div>
    </div>
