...
const quizQuestions = [
  {
    questionText: 'ما المصطلح الفيزيائي الذي يصف "التغير في الزخم الخطي"؟',
    options: ['القوة', 'الشغل', 'الدفع', 'الطاقة'],
    correctAnswerIndex: 2,
    explanation: 'الدفع (Impulse) يُعرّف بأنه التغير في الزخم الخطي لجسم. $I = \\Delta p$.'
  },
  {
  ...
  },
  {
    ...
    correctAnswerIndex: 2,
    explanation: 'التغير في الزخم (من سرعة معينة إلى صفر) يبقى ثابتًا. لكن بزيادة زمن التصادم ($\\Delta t$)، فإن القوة المؤثرة ($\\frac{\\Delta p}{\\Delta t}$) تقل بشكل كبير، مما يحمي الراكب.'
  },
];
