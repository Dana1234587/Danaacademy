...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['$20,000 kg \\cdot m/s$ شرقًا', '$50 kg \\cdot m/s$ شرقًا', '$20,000 N \\cdot s$ غربًا', '$200,000 kg \\cdot m/s$ شرقًا'],
  ...
  },
  {
    ...
    options: [
        'جسم كتلته $2 kg$ يتحرك بسرعة $6 m/s$ يمينًا.',
        'جسم كتلته $3 kg$ يتحرك بسرعة $5 m/s$ يسارًا.',
        'جسم كتلته $4 kg$ يتحرك بسرعة $3 m/s$ يمينًا.',
        'جسم كتلته $1 kg$ يتحرك بسرعة $10 m/s$ يسارًا.'
    ],
    correctAnswerIndex: 1,
    explanation: 'صعوبة إيقاف الجسم تعتمد على مقدار زخمه الخطي، بغض النظر عن الاتجاه. \nالخيار أ: $p = 2 \\times 6 = 12 kg \\cdot m/s$. \nالخيار ب: $p = 3 \\times 5 = 15 kg \\cdot m/s$. \nالخيار ج: $p = 4 \\times 3 = 12 kg \\cdot m/s$. \nالخيار د: $p = 1 \\times 10 = 10 kg \\cdot m/s$. \nالجسم (ب) يمتلك أكبر مقدار للزخم، لذا هو الأصعب في الإيقاف.'
  },
  {
