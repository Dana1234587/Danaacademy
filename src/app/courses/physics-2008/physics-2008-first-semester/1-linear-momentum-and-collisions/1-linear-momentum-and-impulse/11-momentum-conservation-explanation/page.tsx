...
const navigation = {
  prev: {
    label: 'الحصة السابقة: منحنى (القوة - الزمن)',
    path: '/courses/physics-2008/physics-2008-first-semester/1-linear-momentum-and-collisions/1-linear-momentum-and-impulse/10-force-time-curve',
  },
  next: null, // This is the last lesson for now
};

export default function MomentumConservationExplanationPage() {
  return (
      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold mt-1">حصة رقم (11): حفظ الزخم الخطي (شرح)</h1>
            <p className="text-muted-foreground mt-2 max-w-2xl">
              في هذه الحصة، نبدأ بشرح مبدأ حفظ الزخم الخطي، أحد أهم المبادئ في الفيزياء، ونشتقه من قوانين نيوتن.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <WatermarkedVideoPlayer src="https://iframe.mediadelivery.net/embed/480623/8417659d-32f4-4289-9e15-76ed3d59f0ab?autoplay=false&loop=false&muted=false&preload=true" />
                ...
                <Button variant="ghost" className="w-full justify-start">
                 ...
                 <Dialog>
                    ...
                    <DialogContent className="max-w-xl h-auto max-h-[80vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>ملخص قوانين: حفظ الزخم الخطي</DialogTitle>
                        </DialogHeader>
                        <SummaryPage />
                    </DialogContent>
                 </Dialog>
                 <Dialog>
                    ...
                    <DialogContent className="max-w-4xl h-[90vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>اختبار قصير: حفظ الزخم الخطي</DialogTitle>
                        </DialogHeader>
                        <QuizPage />
                    </DialogContent>
                 </Dialog>
