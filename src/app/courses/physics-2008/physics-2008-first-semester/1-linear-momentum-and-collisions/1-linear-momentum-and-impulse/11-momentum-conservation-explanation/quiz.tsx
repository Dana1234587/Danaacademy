...
const quizQuestions = [
  ...
  {
    questionText: 'ما هو مقدار التغير في الزخم الخطي الكلي لنظام معزول؟',
    options: ['صفر', 'يعتمد على القوى الداخلية', 'يكون موجبًا دائمًا', 'يكون سالبًا دائمًا'],
    correctAnswerIndex: 0,
    explanation: 'لأن النظام معزول، فإن محصلة القوى الخارجية عليه تساوي صفرًا. ووفقًا لقانون نيوتن الثاني، فإن محصلة القوى تساوي المعدل الزمني للتغير في الزخم الخطي الكلي للنظام ($\\Sigma F_{ext} = \\frac{\\Delta p_{sys}}{\\Delta t}$). بما أن الطرف الأيسر صفر، يجب أن يكون التغير في الزخم الخطي الكلي للنظام صفرًا أيضًا.'
  },
  {
