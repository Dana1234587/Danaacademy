      ...
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <WatermarkedVideoPlayer src="https://iframe.mediadelivery.net/embed/480623/1cc8dd00-bb23-43a0-836a-29045e5fb71c?autoplay=false&loop=false&muted=false&preload=true" />
            ...
            <Card>
                ...
                <CardContent>
                    <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                        <li>نص القانون الثاني لنيوتن بدلالة الزخم الخطي.</li>
                ...
                <Button variant="ghost" className="w-full justify-start">
                 ...
                 <Dialog>
                    ...
                    <DialogContent className="max-w-xl h-auto max-h-[80vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>ملخص قوانين: قانون نيوتن الثاني</DialogTitle>
                        </DialogHeader>
                        <SummaryPage />
                    </DialogContent>
                 </Dialog>
                 <Dialog>
                    ...
                    <DialogContent className="max-w-4xl h-[90vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>اختبار قصير: قانون نيوتن الثاني</DialogTitle>
                        </DialogHeader>
                        <QuizPage />
                    </DialogContent>
                 </Dialog>
