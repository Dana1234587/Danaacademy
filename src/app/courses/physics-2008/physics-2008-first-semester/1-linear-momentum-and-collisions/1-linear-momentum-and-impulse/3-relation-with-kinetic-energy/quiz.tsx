...
const quizQuestions = [
  ...
  {
    questionText: 'قمر صناعي كتلته $m$ يدور في مسار دائري بسرعة ثابتة المقدار $v$. ما مقدار التغير في زخمه الخطي ($\\Delta p$) والتغير في طاقته الحركية ($\\Delta K$) عندما يكمل نصف دورة؟',
    options: ['$\\Delta p = 0 , \\Delta K = 0$', '$\\Delta p = 2mv , \\Delta K = 0$', '$\\Delta p = 0 , \\Delta K = mv^2$', '$\\Delta p = 2mv , \\Delta K = mv^2$'],
    correctAnswerIndex: 1,
    explanation: 'الطاقة الحركية ($K=\\frac{1}{2}mv^2$) كمية قياسية وبما أن المقدار v ثابت، فإن الطاقة الحركية ثابتة ويكون التغير فيها صفر ($\\Delta K = 0$). أما الزخم فهو كمية متجهة ($p=mv$). بعد نصف دورة، ينعكس اتجاه السرعة فتصبح $-v$. التغير في الزخم هو $\\Delta p = p_f - p_i = m(-v) - m(v) = -2mv$. مقدار التغير هو $2mv$.'
  },
  {
