...
const quizQuestions = [
  ...
  {
    questionText: 'تحركت شحنة سالبة بسرعة ثابتة داخل مجال كهربائي منتظم. ماذا يمكنك أن تستنتج عن التغير في طاقة وضعها الكهربائية؟',
    options: ['ازدادت', 'قلت', 'بقيت ثابتة', 'لا يمكن تحديد ذلك بدون معرفة اتجاه الحركة'],
    correctAnswerIndex: 3,
    explanation: 'بما أن الشحنة تتحرك بسرعة ثابتة، فإن الشغل الكلي المبذول عليها صفر. هذا يعني أن شغل القوة الخارجية يعاكس شغل القوة الكهربائية ($W_{ext} = -W_{elec}$). التغير في طاقة الوضع يساوي شغل القوة الخارجية ($\\Delta PE = W_{ext}$). إذا تحركت الشحنة مع اتجاه القوة الكهربائية، يكون شغل القوة الخارجية سالبًا وتقل طاقة الوضع. وإذا تحركت عكس اتجاه القوة الكهربائية، يكون شغل القوة الخارجية موجبًا وتزداد طاقة الوضع. بما أن اتجاه الحركة غير محدد، لا يمكن تحديد التغير في طاقة الوضع.'
  },
];
