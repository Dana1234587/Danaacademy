  ...
  <div className="my-4 p-4 bg-muted rounded-lg flex justify-center items-center">
    <svg width="250" height="150" viewBox="0 0 250 150">
      <defs>
        ...
        <marker id="arrowhead-primary" markerWidth="10" markerHeight="7" refX="0" refY="3.5" orient="auto">
          <polygon points="0 0, 10 3.5, 0 7" fill="hsl(var(--primary))" />
        </marker>
      </defs>
      {/* Electric Field Lines */}
      ...
      <line x1="120" y1="75" x2="65" y2="75" stroke="black" strokeWidth="2" markerEnd="url(#arrowhead-black)" />
      <text x="85" y="70" fontSize="12" fill="black">v</text>
      
       {/* Force Vector (moving left) */}
      <line x1="125" y1="95" x2="70" y2="95" stroke="hsl(var(--destructive))" strokeWidth="2" markerEnd="url(#arrowhead-black)" />
