...
const laws = [
    {
        ...
        formula: "\\Delta KE = W_{elec} = -\\Delta PE = -q\\Delta V",
        description: "عندما تتحرك شحنة بفعل القوة الكهربائية فقط، فإن الشغل المبذول عليها يتحول بالكامل إلى طاقة حركية. إذا بدأت الشحنة من السكون، فإن طاقتها الحركية النهائية هي $KE_f = -q\\Delta V = qV_{initial} - qV_{final}$."
    },
    {
        title: "السرعة النهائية",
        formula: "v_f = \\sqrt{\\frac{2q(-\\Delta V)}{m}} = \\sqrt{\\frac{2KE_f}{m}}",
        description: "يمكن اشتقاق السرعة النهائية من معادلة الطاقة الحركية. لاحظ أن السرعة تتناسب عكسيًا مع الجذر التربيعي للكتلة."
    }
];
