      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold mt-1">حصة رقم (16): فرق الجهد بين نقطتين في مجال كهربائي منتظم</h1>
            <p className="text-muted-foreground mt-2 max-w-2xl">
              في هذه الحصة، نتعلم كيفية حساب فرق الجهد بين أي نقطتين في مجال كهربائي منتظم.
            </p>
          </div>
                ...
                <Button variant="ghost" className="w-full justify-start">
                 ...
                 <Dialog>
                    ...
                    <DialogContent className="max-w-xl h-auto max-h-[80vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>ملخص قوانين: فرق الجهد في مجال منتظم</DialogTitle>
                        </DialogHeader>
                        <SummaryPage />
                    </DialogContent>
                 </Dialog>
                 <Dialog>
                    ...
                    <DialogContent className="max-w-4xl h-5/6 overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>اختبار قصير: فرق الجهد في مجال منتظم</DialogTitle>
                        </DialogHeader>
                        <QuizPage />
                    </DialogContent>
                 </Dialog>
