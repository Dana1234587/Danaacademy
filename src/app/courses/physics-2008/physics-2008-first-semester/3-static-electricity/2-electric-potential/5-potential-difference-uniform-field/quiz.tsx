...
const quizQuestions = [
  ...
  {
    questionText: 'فرق الجهد بين نقطتين A و B هو 12 فولت. ما مقدار الشغل اللازم لنقل شحنة مقدارها 2 كولوم من A إلى B؟',
    options: ['6 جول', '24 جول', '12 جول', 'لا يمكن تحديده'],
    correctAnswerIndex: 1,
    explanation: 'الشغل المبذول بواسطة قوة خارجية لنقل شحنة بين نقطتين هو $W = q \\Delta V = q(V_B - V_A)$. بما أن فرق الجهد بين A و B هو 12 فولت، فإن الشغل هو $W = (2 C) \\times (12 V) = 24 J$.'
  },
];
