...
const laws = [
    {
        ...
        formula: "V_{ab} = V_a - V_b = Ed\\cos(\\theta)",
        description: "لحساب فرق الجهد بين نقطتين a و b. حيث E هو شدة المجال المنتظم، d هي المسافة بين النقطتين، و $\\theta$ هي الزاوية بين اتجاه المجال (E) واتجاه الإزاحة من النقطة b إلى النقطة a."
    },
    {
        title: "حالات خاصة للزاوية",
        description: "• **عندما $\\theta = 0^\\circ$ (مع المجال):** $V_{ab} = Ed$. يكون فرق الجهد موجبًا، أي $V_a > V_b$ لأننا نتحرك عكس المجال (من b إلى a). \n• **عندما $\\theta = 180^\\circ$ (عكس المجال):** $V_{ab} = -Ed$. يكون فرق الجهد سالبًا، أي $V_a < V_b$ لأننا نتحرك مع المجال (من b إلى a).\n• **عندما $\\theta = 90^\\circ$ (عمودي على المجال):** $V_{ab} = 0$. الجهد متساوٍ على طول الخط العمودي على المجال."
    },
    {
