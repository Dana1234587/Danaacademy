            ...
            <Card>
                ...
                <CardContent>
                    <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                        <li>تعريف خط المجال الكهربائي.</li>
                        <li>خصائص خطوط المجال الكهربائي.</li>
                        <li>رسم خطوط المجال لشحنات نقطية مختلفة.</li>
                        <li>مفهوم المجال الكهربائي المنتظم.</li>
                    </ul>
                </CardContent>
            </Card>
          </div>
                ...
                <Button variant="ghost" className="w-full justify-start">
                 ...
                 <Dialog>
                    ...
                    <DialogContent className="max-w-xl h-auto max-h-[80vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>ملخص قوانين: خطوط المجال الكهربائي</DialogTitle>
                        </DialogHeader>
                        <SummaryPage />
                    </DialogContent>
                 </Dialog>
                 <Dialog>
                    ...
                    <DialogContent className="max-w-4xl h-[90vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>اختبار قصير: خطوط المجال الكهربائي</DialogTitle>
                        </DialogHeader>
                        <QuizPage />
                    </DialogContent>
                 </Dialog>
