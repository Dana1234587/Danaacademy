      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold mt-1">حصة رقم (5): قانون غاوس</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <WatermarkedVideoPlayer src="https://vz-2adfd2e0-f8c.b-cdn.net/68cc8c59-a2d0-4309-9c76-aefed6570144/playlist.m3u8" />
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <Button variant="ghost" className="w-full justify-start" asChild>
                  <Link href="https://drive.google.com/file/d/1oHD84dkzGX4RKezWtX97iy9RNsXSIU-o/view?usp=sharing" target="_blank" rel="noopener noreferrer">
