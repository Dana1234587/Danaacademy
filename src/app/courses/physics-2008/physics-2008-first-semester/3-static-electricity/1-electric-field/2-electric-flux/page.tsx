...
export default function ElectricFluxPage() {
  return (
            ...
            <Card>
                ...
                <CardContent>
                    <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                        <li>تعريف التدفق الكهربائي.</li>
                        <li>قانون حساب التدفق الكهربائي لسطح مستوٍ في مجال منتظم.</li>
                        <li>العوامل التي يعتمد عليها التدفق الكهربائي.</li>
                        <li>حالات يكون فيها التدفق موجبًا، سالبًا، أو صفرًا.</li>
                    </ul>
                </CardContent>
            </Card>
          </div>
                ...
                <Button variant="ghost" className="w-full justify-start">
                 ...
                 <Dialog>
                    ...
                    <DialogContent className="max-w-xl h-auto max-h-[80vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>ملخص قوانين: التدفق الكهربائي</DialogTitle>
                        </DialogHeader>
                        <SummaryPage />
                    </DialogContent>
                 </Dialog>
                 <Dialog>
                    ...
                    <DialogContent className="max-w-4xl h-[90vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>اختبار قصير: التدفق الكهربائي</DialogTitle>
                        </DialogHeader>
                        <QuizPage />
                    </DialogContent>
                 </Dialog>
