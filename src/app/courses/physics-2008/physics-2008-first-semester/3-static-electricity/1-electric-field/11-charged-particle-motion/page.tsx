      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold mt-1">حصة رقم (11): حركة جسيم مشحون في مجال كهربائي منتظم</h1>
            <p className="text-muted-foreground mt-2 max-w-2xl">
              في هذه الحصة، ندرس كيف تتحرك الجسيمات المشحونة تحت تأثير قوة كهربائية منتظمة.
            </p>
          </div>
            ...
            <Card>
                ...
                <CardContent>
                    <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                        <li>حساب التسارع الذي يكتسبه جسيم مشحون.</li>
                        <li>تطبيق معادلات الحركة بتسارع ثابت.</li>
                        <li>تحليل حركة الجسيمات الموجبة والسالبة في المجال.</li>
                ...
                <Button variant="ghost" className="w-full justify-start">
                 ...
                 <Dialog>
                    ...
                    <DialogContent className="max-w-xl h-auto max-h-[80vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>ملخص قوانين: حركة جسيم مشحون</DialogTitle>
                        </DialogHeader>
                        <SummaryPage />
                    </DialogContent>
                 </Dialog>
                 <Dialog>
                    ...
                    <DialogContent className="max-w-4xl h-5/6 overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>اختبار قصير: حركة جسيم مشحون</DialogTitle>
                        </DialogHeader>
                        <QuizPage />
                    </DialogContent>
                 </Dialog>
