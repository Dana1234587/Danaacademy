...
const quizQuestions = [
    {
        questionText: 'مواسعان موصلان على التوالي، سعة الأول $C$ وسعة الثاني $3C$. ما نسبة طاقة الوضع المخزنة في المواسع الأول إلى الثاني ($\\frac{U_1}{U_2}$)؟',
        options: ['$\\frac{1}{3}$', '$\\frac{1}{9}$', '$3$', '$9$'],
        correctAnswerIndex: 2,
        explanation: 'على التوالي: الشحنة متساوية $Q_1 = Q_2 = Q$\nنستخدم قانون الطاقة: $U = \\frac{Q^2}{2C}$\n$U_1 = \\frac{Q^2}{2C}$ و $U_2 = \\frac{Q^2}{2(3C)} = \\frac{Q^2}{6C}$\n$\\frac{U_1}{U_2} = \\frac{Q^2/2C}{Q^2/6C} = \\frac{6C}{2C} = 3$\n✅ المواسع الأصغر سعة يخزن طاقة أكبر على التوالي!'
    },
    {
        questionText: 'مواسعان موصلان على التوازي، سعة الأول $C$ وسعة الثاني $3C$. ما نسبة طاقة الوضع المخزنة في المواسع الأول إلى الثاني ($\\frac{U_1}{U_2}$)؟',
        options: ['$\\frac{1}{3}$', '$\\frac{1}{9}$', '$3$', '$9$'],
        correctAnswerIndex: 0,
        explanation: 'على التوازي: الجهد متساوي $V_1 = V_2 = V$\nنستخدم قانون الطاقة: $U = \\frac{1}{2}CV^2$\n$U_1 = \\frac{1}{2}CV^2$ و $U_2 = \\frac{1}{2}(3C)V^2 = \\frac{3}{2}CV^2$\n$\\frac{U_1}{U_2} = \\frac{\\frac{1}{2}CV^2}{\\frac{3}{2}CV^2} = \\frac{1}{3}$\n✅ المواسع الأكبر سعة يخزن طاقة أكبر على التوازي!'
    },
    {
