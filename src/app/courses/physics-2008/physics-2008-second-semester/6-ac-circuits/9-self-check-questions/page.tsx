...
export default function SelfCheckQuestionsPage() {
    return (
            ...
            <div className="p-4 sm:p-6 lg:p-8">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                    <div>
                        ...
                        <h1 className="text-3xl font-bold mt-1">حصة رقم (9): حل أسئلة اختبر نفسك</h1>
                        <p className="text-muted-foreground mt-2 max-w-2xl">
                            حل مفصل لأسئلة "اختبر نفسك" الخاصة بدارات التيار المتردد.
                        </p>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <WatermarkedVideoPlayer src="https://vz-2adfd2e0-f8c.b-cdn.net/54c7cd6c-fe98-474d-b92c-63dc8154a72c/playlist.m3u8" />
