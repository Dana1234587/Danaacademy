                    ...
                    lessons: [
                      {
                        ...
                        topics: [
                          ...
                          { label: 'حصة رقم (9): حل أسئلة اختبر نفسك', path: '/courses/physics-2008/physics-2008-second-semester/6-ac-circuits/9-self-check-questions' }
                        ]
                      },
                      {
                        title: 'الدرس الثاني: الدارات الإلكترونية',
                        dossierUrl: 'https://drive.google.com/file/d/1RDs2cCN0KZv0_bz5oKo0rwILSl6IRS69/view?usp=sharing',
                        topics: [
