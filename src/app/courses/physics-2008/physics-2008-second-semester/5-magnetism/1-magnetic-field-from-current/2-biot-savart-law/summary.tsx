...
const laws = [
    ...
    },
    {
        ...
        description: "هذه الصيغة تعطي اتجاه المجال المغناطيسي بالإضافة إلى مقداره. اتجاه المجال يكون عموديًا على كل من عنصر التيار ومتجه الوحدة، ويتم تحديده باستخدام قاعدة اليد اليمنى."
    }
];
