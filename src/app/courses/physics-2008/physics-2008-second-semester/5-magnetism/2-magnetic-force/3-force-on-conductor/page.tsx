            ...
            <div className="p-4 sm:p-6 lg:p-8">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                    <div>
                        ...
                        <h1 className="text-3xl font-bold mt-1">حصة رقم (3): القوة المغناطيسية المؤثرة في موصل</h1>
                        <p className="text-muted-foreground mt-2 max-w-2xl">
                            ندرس القوة المغناطيسية المؤثرة في موصل يحمل تياراً ومغمور في مجال مغناطيسي خارجي.
                        </p>
                    </div>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                                    <li>قانون القوة المغناطيسية على موصل: F = BIL sin(θ)</li>
                                    <li>شروط تطبيق القانون.</li>
                                    <li>تحديد اتجاه القوة باستخدام قاعدة اليد اليمنى.</li>
                                </ul>
                            </CardContent>
                        </Card>
                    </div>
                            ...
                            <CardContent className="space-y-3">
                                ...
                                <Dialog>
                                    ...
                                    <DialogContent className="max-w-xl h-auto max-h-[80vh] overflow-y-auto">
                                        <DialogHeader>
                                            <DialogTitle>ملخص: القوة المغناطيسية على موصل</DialogTitle>
                                        </DialogHeader>
                                        <SummaryPage />
                                    </DialogContent>
                                </Dialog>
                                <Dialog>
                                    ...
                                    <DialogContent className="max-w-4xl h-[90vh] overflow-y-auto">
                                        <DialogHeader>
                                            <DialogTitle>اختبار قصير: القوة على الموصل</DialogTitle>
                                        </DialogHeader>
                                        <QuizPage />
                                    </DialogContent>
                                </Dialog>
